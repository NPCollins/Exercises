...
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES (7, 'Aerosmith Reservation', GETDATE()-3, GETDATE()+2);
...
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES (20, 'Zuckerberg Family Reservation', GETDATE()+30, GETDATE()+33);
